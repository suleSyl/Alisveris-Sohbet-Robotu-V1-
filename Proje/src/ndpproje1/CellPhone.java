...
public class CellPhone extends Product implements Comparable<CellPhone> {
    ...
    private float cPolarity = 0;

    public CellPhone(String category, String brand, String model, float screen, int cameraMp, int frontCameraMp, int storage, int ram, int price) {
    ...
    public float getcPolarity() {
        return cPolarity;
    }

    @Override
    public int compareTo(CellPhone o) {
        return new Float(this.cPolarity).compareTo(o.cPolarity);
    }    
}
